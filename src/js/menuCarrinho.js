...
function desenharProdutoCarrinho(idProduto) {
  ...
  const cartaoProdutoCarrinho = `<button id="remover-item-${
    produto.id
  }" class="absolute top-0 right-2" id="fechar-carrinho"><i class="fa-solid fa-circle-xmark text-slate-500 hover:text-slate-700"></i></button>
    <img src="src/assets/img/${produto.imagem}" alt="${
    produto.nome
